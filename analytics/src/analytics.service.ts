...
import { UpdatePropertyAction, DeletePropertyAction, SendEventAction, RetryEventAction } from './analytics.action';
import { Property } from './property.model';
import { AnalyticsState } from './analytics.state';
// Libs
import { Service } from '@libs/interfaces';
import { PlatformService, LayoutService, PlatformState, LayoutState } from '@libs/util';
...
export class AnalyticsService<T extends any | AnalyticKey = AnalyticKey> extends Service<AnalyticsState<T>> {
  constructor ( private readonly _config: Config, private readonly _platform: PlatformService, private readonly _layout: LayoutService, protected readonly _store: Store<any> ) {
