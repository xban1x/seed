...
// Libs
import { OperatingSystem, DeviceType, Browser, RenderingMode, NavigationType } from '@libs/enums';
...
export class PlatformService extends Service<PlatformState> {
  ...
  private _initState ( headers?: any ): PlatformState {
    ...
    state.operatingSystemVersion = state.operatingSystemVersion.replace( /(-|_| |\/|,)/, '.' );
