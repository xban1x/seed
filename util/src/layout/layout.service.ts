...
export class LayoutService extends Service<LayoutState> {
  ...
  private async _init (): Promise<void> {
    ...
    if ( this._fullScreenSupport ) {
      this._document.addEventListener( 'fullscreenchange', () => this._handleFullScreen() );
      this._document.addEventListener( 'webkitfullscreenchange', () => this._handleFullScreen() );
      this._document.addEventListener( 'mozfullscreenchange', () => this._handleFullScreen() );
    }
  ...
  isFullScreen (): boolean {
    return !!( this._document.webkitIsFullScreen || this._document.mozFullScreen ||
  ...
  private _fullScreenPolyfill (): boolean {
    try {
      this._document.body.requestFullScreen = this._document.body.webkitRequestFullScreen ||
        this._document.body.mozRequestFullScreen || this._document.body.requestFullScreen;
      this._document.cancelFullScreen = this._document.webkitCancelFullScreen ||
        this._document.mozCancelFullScreen || this._document.cancelFullScreen;
      return !isNil( this._document.body.requestFullScreen )
