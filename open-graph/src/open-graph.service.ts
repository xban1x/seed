...
export class OpenGraphService {
	...
	setImage(url: string, imageExtras?: VideoExtras): void {
		...
		if (imageExtras.secureUrl) {
			this._meta.updateTag(
				{ property: 'og:image:secure_url', content: imageExtras.secureUrl },
				true
			);
		}
		if (imageExtras.type) {
			this._meta.updateTag(
				{ property: 'og:image:type', content: imageExtras.type },
				true
			);
		}
		if (imageExtras.width) {
			this._meta.updateTag(
				{ property: 'og:image:width', content: '' + imageExtras.width },
				true
			);
		}
		if (imageExtras.height) {
			this._meta.updateTag(
				{ property: 'og:image:type', content: '' + imageExtras.height },
				true
			);
		}
		if (imageExtras.alt) {
			this._meta.updateTag(
				{ property: 'og:image:alt', content: imageExtras.alt },
				true
			);
		}
	}
	...
	setVideo(url: string, videoExtras?: VideoExtras): void {
		...
		if (videoExtras.secureUrl) {
			this._meta.updateTag(
				{ property: 'og:video:secure_url', content: videoExtras.secureUrl },
				true
			);
		}
		if (videoExtras.type) {
			this._meta.updateTag(
				{ property: 'og:video:type', content: videoExtras.type },
				true
			);
		}
		if (videoExtras.width) {
			this._meta.updateTag(
				{ property: 'og:video:width', content: '' + videoExtras.width },
				true
			);
		}
		if (videoExtras.height) {
			this._meta.updateTag(
				{ property: 'og:video:type', content: '' + videoExtras.height },
				true
			);
		}
		if (videoExtras.alt) {
			this._meta.updateTag(
				{ property: 'og:video:alt', content: videoExtras.alt },
				true
			);
		}
	}
	...
	setAudio(url: string, audioExtras?: AudioExtras): void {
		...
		if (audioExtras.secureUrl) {
			this._meta.updateTag(
				{ property: 'og:audio:secure_url', content: audioExtras.secureUrl },
				true
			);
		}
		if (audioExtras.type) {
			this._meta.updateTag(
				{ property: 'og:audio:type', content: audioExtras.type },
				true
			);
		}
	}
